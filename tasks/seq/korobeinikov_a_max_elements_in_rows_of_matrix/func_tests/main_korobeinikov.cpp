...
TEST(max_elements_in_rows_of_matrix_seq, Test_4_Unequal_number_of_elements_in_rows_exeption) {
  // Create data
  int count_rows = 2;  // not const, because reinterpret_cast does not work with const
...
TEST(max_elements_in_rows_of_matrix_seq, Test_5_number_of_elements_in_the_output_is_not_equal_to_number_of_rows_exeption) {
  // Create data
  int count_rows = 2;  // not const, because reinterpret_cast does not work with const
  std::vector<int> matrix{1, 2, 3, 4, 5};
