...
bool veliev_e_sum_rows_matrix_seq::TestTaskSequential::pre_processing() {
  internal_order_test();
...
bool veliev_e_sum_rows_matrix_seq::TestTaskSequential::validation() {
  internal_order_test();

  return taskData->outputs_count[0] == taskData->inputs_count[0];
}

bool veliev_e_sum_rows_matrix_seq::TestTaskSequential::run() {
  internal_order_test();
...
bool veliev_e_sum_rows_matrix_seq::TestTaskSequential::post_processing() {
  internal_order_test();
