...
TEST(petrov_a_Shell_sort_seq, test_sorted_ascending) { template_test({1, 2, 3, 4, 5, 6, 7, 8}); }

TEST(petrov_a_Shell_sort_seq, test_almost_sorted_random) { template_test({9, 7, 5, 3, 1, 2, 4, 6}); }

TEST(petrov_a_Shell_sort_seq, test_sorted_descending) { template_test({8, 7, 6, 5, 4, 3, 2, 1}); }

TEST(petrov_a_Shell_sort_seq, test_all_equal_elements) { template_test({5, 5, 5, 5, 5, 5, 5, 5}); }

TEST(petrov_a_Shell_sort_seq, test_random_vector) {
  auto random_vec = generate_random_vector(1000, -1000, 1000);
  template_test(random_vec);
}
