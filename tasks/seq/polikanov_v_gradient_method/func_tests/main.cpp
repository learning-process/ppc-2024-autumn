...
TEST(polikanov_v_gradient_method_seq, test_simple_system) {
  int size = 2;
...
TEST(polikanov_v_gradient_method_seq, test_larger_system) {
  int size = 3;
...
TEST(polikanov_v_gradient_method_seq, test_diagonal_matrix) {
  int size = 3;
...
TEST(polikanov_v_gradient_method_seq, test_positive_definite) {
  int size = 3;
...
TEST(polikanov_v_gradient_method_seq, random_test1) {
  int size = 5;
...
TEST(polikanov_v_gradient_method_seq, random_test2) {
  int size = 5;
  std::vector<double> flat_matrix = {
...
TEST(polikanov_v_gradient_method_seq, random_test3) {
  int size = 4;
...
TEST(polikanov_v_gradient_method_seq, random_test4) {
  int size = 4;
...
TEST(polikanov_v_gradient_method_seq, random_test5) {
  int size = 2;
