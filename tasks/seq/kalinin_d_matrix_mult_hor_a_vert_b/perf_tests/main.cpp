...
TEST(kalinin_d_matrix_mult_hor_a_vert_b, test_pipeline_run) {
  // Create data
  ...
  // Create Task
  auto MultHorAVertBTaskSequential = std::make_shared<kalinin_d_matrix_mult_hor_a_vert_b::MultHorAVertBTaskSequential>(taskDataSeq);
...
TEST(kalinin_d_matrix_mult_hor_a_vert_b, test_task_run) {
   // Create data
    std::vector<size_t> dimensions = {100, 100, 100, 100};
    std::vector<int> matrix_a(10000, 1);
    std::vector<int> matrix_b(10000, 1);
