// Copyright 2024 Sharamygina Irina
...
namespace sharamygina_i_most_different_neighbor_elements_seq {
	void getRandomVector(std::vector<int>& v) {
...
TEST(sharamygina_i_most_different_neighbor_elements_seq, wrong_data) {
	std::vector<int> in = {};
	...
	sharamygina_i_most_different_neighbor_elements_seq::most_different_neighbor_elements_seq testTaskSequential(taskDataSeq);
