...
TEST(kolokolova_d_max_of_vector_elements_seq, Test_Max1) {
    ...
    std::vector<int32_t> ans = {9, 9, 5}; // Ожидаемые максимумы
...
TEST(kolokolova_d_max_of_vector_elements_seq, Test_Max2) {
    ...
    std::vector<int32_t> seq_max_vec(count_rows, 0);
    std::vector<int32_t> ans = {9, 13, 12}; // Ожидаемые максимумы
...
TEST(kolokolova_d_max_of_vector_elements_seq, Test_Max3) {
    ...
    std::vector<int32_t> seq_max_vec(count_rows, 0);
    std::vector<int32_t> ans = {10, 13, 12, 10}; // Ожидаемые максимумы
