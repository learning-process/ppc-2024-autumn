...
static std::vector<Point<double>> rectImage{
    Point(140.0, 68.0, 69.0), Point(79.0, 171.0, 10.0),   Point(200.0, 245.0, 187.0), Point(255.0, 255.0, 255.0),
    Point(123.0, 77.0, 92.0), Point(87.0, 204.0, 99.0),   Point(100.0, 211.0, 19.0),  Point(177.0, 62.0, 14.0),
    Point(47.0, 128.0, 95.0), Point(129.0, 210.0, 223.0), Point(199.0, 43.0, 4.0),    Point(0.0, 0.0, 0.0)};

static std::vector<Point<double>> squareImage2{
...
static std::vector<Point<double>> rectImage2{
...
static std::vector<Point<double>> squareImageCheck{
...
static std::vector<Point<double>> rectImageCheck{
...
static std::vector<Point<double>> squareImage2Check{
