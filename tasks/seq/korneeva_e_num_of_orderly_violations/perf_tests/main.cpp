...
TEST(korneeva_e_num_of_orderly_violations_seq, test_pipeline_run) {
  const int numElements = 100000000; // Size of input data
    ...
    auto violationCounterTask = std::make_shared<korneeva_e_num_of_orderly_violations_seq::OrderlyViolationsCounter<int, int>>(taskData);
...
TEST(korneeva_e_num_of_orderly_violations_seq, test_task_run) {
  const int dataSize = 100000000;
    ...
    auto violationCounter = std::make_shared<korneeva_e_num_of_orderly_violations_seq::OrderlyViolationsCounter<int, int>>(taskData);
