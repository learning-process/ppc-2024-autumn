...
void runRandomTest(int size) {
    ...
    std::generate(numbers.begin(), numbers.end(), [&distribution, &randomEngine] 
...
TEST(korneeva_e_num_of_orderly_violations_seq, NoViolations) {
    runOrderlyViolationsTest<int>({1, 2, 3, 4, 5}, 0);
}

TEST(korneeva_e_num_of_orderly_violations_seq, AllViolations) {
    runOrderlyViolationsTest<int>({5, 4, 3, 2, 1}, 4);
}

TEST(korneeva_e_num_of_orderly_violations_seq, MixedViolations) {
    runOrderlyViolationsTest<int>({1, 3, 2, 4, 0}, 2);
}

TEST(korneeva_e_num_of_orderly_violations_seq, SingleElement) {
    runOrderlyViolationsTest<int>({42}, 0);
}
...
TEST(korneeva_e_num_of_orderly_violations_seq, Test_0_int) {
    runOrderlyViolationsTest<int>({}, 0); 
}

TEST(korneeva_e_num_of_orderly_violations_seq, Test_Random_10_int) {
    runRandomTest<int>(10);
}

TEST(korneeva_e_num_of_orderly_violations_seq, Test_Random_100_int) {
    runRandomTest<int>(100);
}

TEST(korneeva_e_num_of_orderly_violations_seq, Test_Random_1000_int) {
    runRandomTest<int>(1000);
}

TEST(korneeva_e_num_of_orderly_violations_seq, Test_Random_10000_int) {
    runRandomTest<int>(10000);
}
...
TEST(korneeva_e_num_of_orderly_violations_seq, SingleElement_double) {
    runOrderlyViolationsTest<double>({42.0}, 0);
}
...
TEST(korneeva_e_num_of_orderly_violations_seq, Test_0_double) {
    runOrderlyViolationsTest<double>({}, 0);
}

TEST(korneeva_e_num_of_orderly_violations_seq, Test_Random_10_double) {
    runRandomTest<double>(10);
}

TEST(korneeva_e_num_of_orderly_violations_seq, Test_Random_100_double) {
    runRandomTest<double>(100);
}

TEST(korneeva_e_num_of_orderly_violations_seq, Test_Random_1000_double) {
    runRandomTest<double>(1000);
}

TEST(korneeva_e_num_of_orderly_violations_seq, Test_Random_10000_double) {
    runRandomTest<double>(10000);
}
