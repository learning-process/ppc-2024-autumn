...
TEST(khasanyanov_k_matrix_tests_seq, test_cant_add) {
  matrix<int> A{3, 2, {5, 6, 7, 8, 5, 6}};
  matrix<int> B{4, 3, {8, 7, 8, 5, 87, 7, 6, 9, 0, 9, 79, 7}};
  EXPECT_FALSE(A == B);
...
TEST(khasanyanov_k_matrix_tests_seq, test_int_3_4_4_3) {
...
TEST(khasanyanov_k_matrix_tests_seq, test_int_2_2_2_2) {
...
TEST(khasanyanov_k_matrix_tests_seq, test_double_2_3_3_1) {
...
TEST(khasanyanov_k_matrix_tests_seq, test_hard_double_4_5_5_6) {
...
TEST(khasanyanov_k_matrix_tests_seq, test_int_sequential_multiply) {
  matrix<int> A{3, 4, {5, 6, 7, 8, 5, 6, 8, 89, 8, 4, 6, 6}};
  matrix<int> B{4, 3, {8, 7, 8, 5, 87, 7, 6, 9, 0, 9, 79, 7}};
  matrix<int> expected_solution{3, 3, {184, 1252, 138, 919, 7660, 705, 174, 932, 134}};
