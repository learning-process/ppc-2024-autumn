...
double frolova_e_Simpson_method_seq::squaresOfX(const std::vector<double>& point, int dimension) { 
    
    double x = point[0];
    return x * x;
}

double frolova_e_Simpson_method_seq::cubeOfX(const std::vector<double>& point, int dimension) {

    double x = point[0];
    return x * x * x;
}

double frolova_e_Simpson_method_seq::sumOfSquaresOfXandY(const std::vector<double>& point, int dimension) { 
...
double frolova_e_Simpson_method_seq::ProductOfXAndY(const std::vector<double>& point, int dimension) {
...
double frolova_e_Simpson_method_seq::sumOfSquaresOfXandYandZ(const std::vector<double>& point, int dimension) {
    double x = point[0];
    double y = point[1];
    double z = point[2];
    return x * x + y * y + z * z;
...
double frolova_e_Simpson_method_seq::ProductOfSquaresOfXandYandZ(const std::vector<double>& point, int dimension) {
    double x = point[0];
    double y = point[1];
    double z = point[2];
    return x * y * z;
