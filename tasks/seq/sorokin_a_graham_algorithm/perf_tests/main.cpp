...
TEST(sorokin_a_graham_algorithm_seq, Elem1000) {
  // Create data
  std::vector<int> in = getrndvec(2000, -100, 100);
...
TEST(sorokin_a_graham_algorithm_seq, Elem10000) {
  // Create data
  std::vector<int> in = getrndvec(20000, -100, 100);
  std::vector<int> out(in.size(), 0);
...
TEST(sorokin_a_graham_algorithm_seq, Elem100000) {
  // Create data
