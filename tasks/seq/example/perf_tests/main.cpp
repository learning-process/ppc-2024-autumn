...
TEST(sequential_example_perf_test, test_int_task_task_run) {
  ...
  taskDataSeq->inputs.emplace_back(reinterpret_cast<void *>(&func));
  taskDataSeq->inputs_count.emplace_back(1);
  taskDataSeq->inputs.emplace_back(lower_bounds.data());
  taskDataSeq->inputs_count.emplace_back(lower_bounds.size());
  taskDataSeq->inputs.emplace_back(upper_bounds.data());
  taskDataSeq->inputs_count.emplace_back(upper_bounds.size());
  taskDataSeq->inputs.emplace_back(intervals.data());
