...
std::vector<int> budazhapova_betcher_odd_even_merge_seq::MergeSequential::generateRandomVector(int size, int minValue, int maxValue) {
...
TEST(budazhapova_betcher_odd_even_merge_seq, validation_test) {
	std::vector<int> input_vector.generateRandomVector = {};
