...
TEST(kholin_k_vector_neighbor_diff_elems_seq, check_int32_t) {
  ...
  // Create Task
  kholin_k_vector_neighbor_diff_elems_seq::MostDiffNeighborElements<int32_t> testTaskSequential(taskData);
...
//TEST(kholin_k_vector_neighbour_diff_elems_seq, check_validate_func) {
//  // Create data
...
//
//  // Create Task
//  kholin_k_vector_neighbor_diff_elems_seq::MostDiffNeighborElements<double> testTaskSequential(taskData);
//  bool isValid = testTaskSequential.validation();
//  EXPECT_EQ(isValid, true);
//  testTaskSequential.pre_processing();
//  testTaskSequential.run();
...
//
//  // Create Task
//  kholin_k_vector_neighbor_diff_elems_seq::MostDiffNeighborElements<int8_t> testTaskSequential(taskData);
//  bool isValid = testTaskSequential.validation();
//  EXPECT_EQ(isValid, true);
//  testTaskSequential.pre_processing();
//  testTaskSequential.run();
...
//
//  // Create Task
//  kholin_k_vector_neighbor_diff_elems_seq::MostDiffNeighborElements <int64_t> testTaskSequential(taskData);
//  bool isValid = testTaskSequential.validation();
//  EXPECT_EQ(isValid, true);
//  testTaskSequential.pre_processing();
//  testTaskSequential.run();
...
//
//  // Create Task
//  kholin_k_vector_neighbor_diff_elems_seq::MostDiffNeighborElements<float> testTaskSequential(taskData);
//  bool isValid = testTaskSequential.validation();
//  EXPECT_EQ(isValid, true);
//  testTaskSequential.pre_processing();
//  testTaskSequential.run();
