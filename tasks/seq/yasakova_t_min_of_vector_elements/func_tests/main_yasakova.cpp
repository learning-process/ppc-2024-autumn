...
std::vector<int> yasakova_t_min_of_vector_elements_seq::RandomVector(int size, int minimum = 0, int maximum = 100) {
...
std::vector<std::vector<int>> yasakova_t_min_of_vector_elements_seq::RandomMatrix(int rows, int columns, int minimum = 0,
                                                                                  int maximum = 100) {
