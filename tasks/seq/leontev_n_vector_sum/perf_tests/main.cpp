...
TEST(leontev_n_vector_sum_seq, test_pipeline_run) {
  ...
  // Create Task
  auto vecSumSequential = std::make_shared<leontev_n_vector_sum_seq::VecSumSequential<int>>(taskDataSeq);
  ...
  auto perfAnalyzer = std::make_shared<ppc::core::Perf>(vecSumSequential);
