...
TEST(Parallel_Operations_TBB, Test_Sum) {
  ...
  // Create Task
  chistov_a_test_task_tbb::TestTBBTaskSequential testTbbTaskSequential(taskDataSeq, "+");
  ...
  // Create Task
  chistov_a_test_task_tbb::TestTBBTaskParallel testTbbTaskParallel(taskDataPar, "+");
...
TEST(Parallel_Operations_TBB, Test_Diff_2) {
  std::vector<int> vec = chistov_a_test_task_tbb::getRandomVector(50);
  // Create data
  std::vector<int> ref_res(1, 0);
...
TEST(Parallel_Operations_TBB, Test_Mult) {
  std::vector<int> vec = chistov_a_test_task_tbb::getRandomVector(10);
  // Create data
  std::vector<int> ref_res(1, 0);
...
TEST(Parallel_Operations_TBB, Test_Mult_2) {
  std::vector<int> vec = chistov_a_test_task_tbb::getRandomVector(5);
  // Create data
  std::vector<int> ref_res(1, 0);
