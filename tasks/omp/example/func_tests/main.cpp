...
TEST(Parallel_Operations_OpenMP, Test_Sum) {
  std::vector<int> vec = chistov_a_test_task_omp::getRandomVector(100);
  // Create data
  ...
  // Create Task
  chistov_a_test_task_omp::TestOMPTaskSequential testOmpTaskSequential(taskDataSeq, "+");
  ...
  // Create Task
  chistov_a_test_task_omp::TestOMPTaskParallel testOmpTaskParallel(taskDataPar, "+");
...
TEST(Parallel_Operations_OpenMP, Test_Diff_2) {
  std::vector<int> vec = chistov_a_test_task_omp::getRandomVector(10);
  // Create data
  std::vector<int> ref_res(1, 0);
...
TEST(Parallel_Operations_OpenMP, Test_Mult_2) {
  std::vector<int> vec = chistov_a_test_task_omp::getRandomVector(5);
  // Create data
  std::vector<int> ref_res(1, 0);
