...
bool ermilova_d_reduceMPI_mpi::TestMPITaskSequential::validation() {
  internal_order_test();
  // Check count elements of output
  return taskData->outputs_count[0] == 1 && taskData->inputs_count[0] > 0 && taskData->inputs_count[1] > 0;
}

bool ermilova_d_reduceMPI_mpi::TestMPITaskSequential::run() {
  internal_order_test();
...
bool ermilova_d_reduceMPI_mpi::TestMPITaskSequential::post_processing() {
  internal_order_test();
