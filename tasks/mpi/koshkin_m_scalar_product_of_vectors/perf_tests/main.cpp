...
TEST(koshkin_m_scalar_product_of_vectors, test_pipeline_run) {
  ...
  std::vector<int> vec_1 = koshkin_m_scalar_product_of_vectors::createRandomVector(count_size);
  std::vector<int> vec_2 = koshkin_m_scalar_product_of_vectors::createRandomVector(count_size);
