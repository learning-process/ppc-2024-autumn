...
class SeidelIterateMethodsMPI : public ppc::core::Task {
 public:
  ...
  bool set_matrix(const std::vector<std::vector<double>>& matrix, const std::vector<double>& vector);
  static bool generate_random_diag_dominant_matrix(int size, std::vector<std::vector<double>>& matrix,
