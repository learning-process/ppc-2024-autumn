...
TEST(agafeev_s_max_of_vector_elements, test_pipeline_run) {
  ...
  agafeev_s_max_of_vector_elements_mpi::MaxMatrixMpi testTask(taskData);
  auto testTaskSequential = std::make_shared<agafeev_s_max_of_vector_elements_mpi::MaxMatrixMpi>(taskData);
