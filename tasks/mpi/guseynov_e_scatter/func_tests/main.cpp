...
TEST(guseynov_e_scatter_mpi, Test_aray_57){
...
TEST(guseynov_e_scatter_mpi, Test_aray_79){
    boost::mpi::communicator world;
    std::vector<int> global_vec(100, 1);
    std::vector<int32_t> global_res(1, -1);
     // Create TaskData
...
TEST(guseynov_e_scatter_mpi, Test_aray_100){
    boost::mpi::communicator world;
    std::vector<int> global_vec(100, 1);
    std::vector<int32_t> global_res(1, -1);
     // Create TaskData
...
TEST(guseynov_e_scatter_mpi, Test_aray_153){
    boost::mpi::communicator world;
    std::vector<int> global_vec(100, 1);
    std::vector<int32_t> global_res(1, -1);
     // Create TaskData
 ...
 TEST(guseynov_e_scatter_mpi, Test_aray_645){
    boost::mpi::communicator world;
    std::vector<int> global_vec(100, 1);
    std::vector<int32_t> global_res(1, -1);
     // Create TaskData
