...
TEST(guseynov_e_scatter_mpi, Test_seq_empty_array) {
  const int count = 0;
...
TEST(guseynov_e_scatter_mpi, Test_boost_scatter_empty_array) {
...
TEST(guseynov_e_scatter_mpi, Test_my_scatter_empty_array) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_res(1, -1);
  // Create TaskData
...
TEST(guseynov_e_scatter_mpi, Test_my_scatter_array_79) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_res(1, -1);
  // Create TaskData
...
TEST(guseynov_e_scatter_mpi, Test_my_scatter_array_100) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_res(1, -1);
  // Create TaskData
...
TEST(guseynov_e_scatter_mpi, Test_my_scatter_array_153) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_res(1, -1);
  // Create TaskData
...
TEST(guseynov_e_scatter_mpi, Test_my_scatter_array_645) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_res(1, -1);
  // Create TaskData
