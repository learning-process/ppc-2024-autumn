...
bool veliev_e_sum_rows_matrix_mpi::TestTaskSequential ::pre_processing() {
  internal_order_test();
...
bool veliev_e_sum_rows_matrix_mpi::TestTaskSequential::validation() {
  internal_order_test();

  return taskData->outputs_count[0] == taskData->inputs_count[0];
}

bool veliev_e_sum_rows_matrix_mpi::TestTaskSequential ::run() {
  internal_order_test();
...
bool veliev_e_sum_rows_matrix_mpi::TestTaskSequential ::post_processing() {
  internal_order_test();
...
bool veliev_e_sum_rows_matrix_mpi::TestTaskParallel::pre_processing() {
  internal_order_test();
...
bool veliev_e_sum_rows_matrix_mpi::TestTaskParallel::validation() {
  internal_order_test();
...
bool veliev_e_sum_rows_matrix_mpi::TestTaskParallel::run() {
  internal_order_test();
...
bool veliev_e_sum_rows_matrix_mpi::TestTaskParallel::post_processing() {
  internal_order_test();
