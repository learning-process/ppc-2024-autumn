...
TEST(grudzin_k_all_reduce_mpi, Test_Seq_and_Boost_Ver_2000x2000) {
  int rows = 2000;
  int colums = 2000;
  ...
  grudzin_k_all_reduce_mpi::TestMPITaskBoostRealization TestMPITaskBoostRealization(taskDataPar);
  ...
  if (world.rank() == 0) {
    ...
    grudzin_k_all_reduce_mpi::TestMPITaskSequential testMpiTaskSequential(taskDataSeq);
...
TEST(grudzin_k_all_reduce_mpi, Test_Seq_and_Boost_Ver_1337) {
  int rows = 13;
  int colums = 37;
...
TEST(grudzin_k_all_reduce_mpi, Test_Seq_and_Boost_Ver_20x30) {
  int rows = 20;
  int colums = 30;
...
TEST(grudzin_k_all_reduce_mpi, Test_My_and_Boost_Ver_2000x2000) {
  int rows = 2000;
  int colums = 2000;
...
TEST(grudzin_k_all_reduce_mpi, Test_My_and_Boost_Ver_20x30) {
  int rows = 20;
  int colums = 30;
...
TEST(grudzin_k_all_reduce_mpi, Empty_Val) {
  const int rows = 0;
  const int colums = 0;
  ...
  if (world.rank() == 0) {
    ...
    grudzin_k_all_reduce_mpi::TestMPITaskMyRealization testMpiTaskMR(taskDataPar);
    grudzin_k_all_reduce_mpi::TestMPITaskBoostRealization testMpiTaskBR(taskDataPar);
    ASSERT_EQ(testMpiTaskSequential.validation(), false);
    ASSERT_EQ(testMpiTaskMR.validation(), false);
    ASSERT_EQ(testMpiTaskBR.validation(), false);
  }
}

TEST(grudzin_k_all_reduce_mpi, Forget_One_Size_Val) {
  const int rows = 10;
  const int colums = 10;
...
TEST(grudzin_k_all_reduce_mpi, Ans_NEQ_Col_Val) {
  const int rows = 10;
  const int colums = 10;
