...
namespace zaitsev_a_scatter_seq {
...
void test_int(int sz, int min = -1000, int max = 1000, int extrema = -5000) {
  ...
  if (world.rank() == 0) {
    inp = zaitsev_a_scatter_seq::get_random_int_vector(sz, min, max, extrema);
...
void test_double(int sz, double min = -10e3, double max = 10e3, double extrema = -10e4) {
  ...
  if (world.rank() == 0) {
    inp = zaitsev_a_scatter_seq::get_random_double_vector(sz, min, max, extrema);
    taskDataPar->inputs.emplace_back(reinterpret_cast<uint8_t*>(inp.data()));
    taskDataPar->inputs_count.emplace_back(sz);
    taskDataPar->outputs.emplace_back(reinterpret_cast<uint8_t*>(ref.data()));
    taskDataPar->outputs_count.emplace_back(1);
...
TEST(zaitsev_a_scatter_mpi, test__dtype_int__size_1e0) { zaitsev_a_scatter_seq::test_int<MPI_Scatter>(1); }
TEST(zaitsev_a_scatter_mpi, test__dtype_int__size_1e2) { zaitsev_a_scatter_seq::test_int<MPI_Scatter>(1e2); }
TEST(zaitsev_a_scatter_mpi, test__dtype_int__size_1e5) { zaitsev_a_scatter_seq::test_int<MPI_Scatter>(1e5); }
TEST(zaitsev_a_scatter_mpi, test__dtype_int__size_1e7) { zaitsev_a_scatter_seq::test_int<MPI_Scatter>(1e7); }
TEST(zaitsev_a_scatter_mpi, test__dtype_double__size_1e0) { zaitsev_a_scatter_seq::test_double<MPI_Scatter>(1); }
TEST(zaitsev_a_scatter_mpi, test__dtype_double__size_1e2) { zaitsev_a_scatter_seq::test_double<MPI_Scatter>(1e2); }
TEST(zaitsev_a_scatter_mpi, test__dtype_double__size_1e3) { zaitsev_a_scatter_seq::test_double<MPI_Scatter>(1e3); }
TEST(zaitsev_a_scatter_mpi, test__dtype_double__size_1e5) { zaitsev_a_scatter_seq::test_double<MPI_Scatter>(1e5); }
