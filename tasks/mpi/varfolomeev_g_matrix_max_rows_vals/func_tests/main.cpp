...
TEST(varfolomeev_g_matrix_max_rows_mpi, Test_Sum) {
  ...
  if (world.rank() == 0) {
    ...
    global_vec = varfolomeev_g_matrix_max_rows_vals_mpi::getRandomVector(count_size_vector);
  ...
  varfolomeev_g_matrix_max_rows_vals_mpi::TestMPITaskParallel testMpiTaskParallel(taskDataPar, "+");
  ...
  if (world.rank() == 0) {
    ...
    // Create Task
    varfolomeev_g_matrix_max_rows_vals_mpi::TestMPITaskSequential testMpiTaskSequential(taskDataSeq, "+");
...
TEST(varfolomeev_g_matrix_max_rows_mpi, Test_Diff) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
...
TEST(varfolomeev_g_matrix_max_rows_mpi, Test_Diff_2) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_diff(1, 0);
  // Create TaskData
...
TEST(varfolomeev_g_matrix_max_rows_mpi, Test_Max) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  ...
  varfolomeev_g_matrix_max_rows_vals_mpi::TestMPITaskParallel testMpiTaskParallel(taskDataPar, "max");
  ASSERT_EQ(testMpiTaskParallel.validation(), true);
  testMpiTaskParallel.pre_processing();
  testMpiTaskParallel.run();
  testMpiTaskParallel.post_processing();
  ...
  if (world.rank() == 0) {
    ...
    // Create Task
    varfolomeev_g_matrix_max_rows_vals_mpi::TestMPITaskSequential testMpiTaskSequential(taskDataSeq, "max");
    ASSERT_EQ(testMpiTaskSequential.validation(), true);
    testMpiTaskSequential.pre_processing();
    testMpiTaskSequential.run();
    testMpiTaskSequential.post_processing();
...
TEST(varfolomeev_g_matrix_max_rows_mpi, Test_Max_2) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_max(1, 0);
  // Create TaskData
