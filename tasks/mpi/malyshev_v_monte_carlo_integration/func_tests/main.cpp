...
#include "malyshev_v_monte_carlo_integration/include/ops_mpi.hpp"

TEST(Parallel_Operations_MPI, Test_Integral_Calculation) {
    boost::mpi::communicator world;
    std::vector<double> global_results(1, 0.0);
    std::shared_ptr<malyshev_v_monte_carlo_integration::TaskData> taskDataPar = std::make_shared<malyshev_v_monte_carlo_integration::TaskData>();
...
TEST(Parallel_Operations_MPI, Test_Correlation_Parallel_Sequential) {
    ...
    std::shared_ptr<malyshev_v_monte_carlo_integration::TaskData> taskDataPar = std::make_shared<malyshev_v_monte_carlo_integration::TaskData>();
    std::shared_ptr<malyshev_v_monte_carlo_integration::TaskData> taskDataSeq = std::make_shared<malyshev_v_monte_carlo_integration::TaskData>();
