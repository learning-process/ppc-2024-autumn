...
//    global_vec = gnitienko_k_sum_row_mpi::getRandomVector(count_size_vector);
...
//  }
//
//  gnitienko_k_sum_row_mpi::TestMPITaskParallel testMpiTaskParallel(taskDataPar, "+");
...
//
//    // Create Task
//    gnitienko_k_sum_row_mpi::TestMPITaskSequential testMpiTaskSequential(taskDataSeq, "+");
...
//  }
//
//  gnitienko_k_sum_row_mpi::TestMPITaskParallel testMpiTaskParallel(taskDataPar, "max");
//  ASSERT_EQ(testMpiTaskParallel.validation(), true);
//  testMpiTaskParallel.pre_processing();
//  testMpiTaskParallel.run();
//  testMpiTaskParallel.post_processing();
...
//
//    // Create Task
//    gnitienko_k_sum_row_mpi::TestMPITaskSequential testMpiTaskSequential(taskDataSeq, "max");
//    ASSERT_EQ(testMpiTaskSequential.validation(), true);
//    testMpiTaskSequential.pre_processing();
//    testMpiTaskSequential.run();
//    testMpiTaskSequential.post_processing();
