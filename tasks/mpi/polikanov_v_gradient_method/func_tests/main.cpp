...
TEST(polikanov_v_gradient_method_mpi, random_test1) {
  int size = 5;
...
TEST(polikanov_v_gradient_method_mpi, random_test2) {
  int size = 5;
  std::vector<double> flat_matrix = {
...
TEST(polikanov_v_gradient_method_mpi, random_test3) {
  int size = 4;
...
TEST(polikanov_v_gradient_method_mpi, random_test4) {
  int size = 4;
