...
// TEST(zaytsev_d_num_of_alternations_signs_mpi, Test_Sum) {
...
// TEST(zaytsev_d_num_of_alternations_signs_mpi, Test_Diff) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
...
// TEST(zaytsev_d_num_of_alternations_signs_mpi, Test_Diff_2) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
//   std::vector<int32_t> global_diff(1, 0);
//   // Create TaskData
...
// TEST(zaytsev_d_num_of_alternations_signs_mpi, Test_Max) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
...
//   zaytsev_d_num_of_alternations_signs_mpi::TestMPITaskParallel testMpiTaskParallel(taskDataPar, "max");
//   ASSERT_EQ(testMpiTaskParallel.validation(), true);
//   testMpiTaskParallel.pre_processing();
//   testMpiTaskParallel.run();
//   testMpiTaskParallel.post_processing();
...
//     // Create Task
//     zaytsev_d_num_of_alternations_signs_mpi::TestMPITaskSequential testMpiTaskSequential(taskDataSeq, "max");
//     ASSERT_EQ(testMpiTaskSequential.validation(), true);
//     testMpiTaskSequential.pre_processing();
//     testMpiTaskSequential.run();
//     testMpiTaskSequential.post_processing();
...
// TEST(zaytsev_d_num_of_alternations_signs_mpi, Test_Max_2) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
//   std::vector<int32_t> global_max(1, 0);
//   // Create TaskData
