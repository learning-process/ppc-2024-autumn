...
static void laganina_e_dejskras_a_mpi::TestMPITaskSequential::get_children_with_weights(
...
static void laganina_e_dejskras_a_mpi::TestMPITaskSequential::dijkstra(int start_vertex,
