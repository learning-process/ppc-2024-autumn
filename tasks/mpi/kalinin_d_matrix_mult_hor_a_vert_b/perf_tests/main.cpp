...
// TEST(kalinin_d_matrix_mult_hor_a_vert_b, pipeline_run) {
...
//   if (world.rank() == 0) {
//     global_matrix_a = kalinin_d_matrix_mult_hor_a_vert_b::getRandomMatrix(rowA, colA);
//     global_matrix_b = kalinin_d_matrix_mult_hor_a_vert_b::getRandomMatrix(colA, colB);
...
//   if (world.rank() == 0) {
//     auto taskSequential =
//         std::make_shared<kalinin_d_matrix_mult_hor_a_vert_b::TestMPITaskSequential>(
//             taskDataSeq);
...
// TEST(kalinin_d_matrix_mult_hor_a_vert_b, task_run) {
//   boost::mpi::environment env;
//   boost::mpi::communicator world;
