...
TEST(frolova_e_matrix_multiplication_mpi, values_are_prime_numbers) {
  ...
  if (world.rank() == 0) {
    frolova_e_matrix_multiplication_mpi::randomNumVec(3721, matrixA_);
    frolova_e_matrix_multiplication_mpi::randomNumVec(3721, matrixB_);
...
TEST(frolova_e_matrix_multiplication_mpi, matrix_with_single_element) {
  ...
  if (world.rank() == 0) {
    frolova_e_matrix_multiplication_mpi::randomNumVec(1, matrixA_);
    frolova_e_matrix_multiplication_mpi::randomNumVec(1, matrixB_);
...
TEST(frolova_e_matrix_multiplication_mpi, matrix_of_size_of_power_of_two) {
  ...
  if (world.rank() == 0) {
    frolova_e_matrix_multiplication_mpi::randomNumVec(4096, matrixA_);
    frolova_e_matrix_multiplication_mpi::randomNumVec(4096, matrixB_);
