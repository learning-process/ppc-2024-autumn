...
std::vector<int> varfolomeev_g_quick_sort_simple_merge_mpi::getRandomVector(int sz) {
...
bool varfolomeev_g_quick_sort_simple_merge_mpi::TestMPITaskSequential::pre_processing() {
  internal_order_test();
  // Init vectors
...
bool varfolomeev_g_quick_sort_simple_merge_mpi::TestMPITaskSequential::validation() {
  internal_order_test();
  // Check count elements of output
  return taskData->outputs_count[0] == 1;
}

bool varfolomeev_g_quick_sort_simple_merge_mpi::TestMPITaskSequential::run() {
  internal_order_test();
  if (ops == "+") {
...
bool varfolomeev_g_quick_sort_simple_merge_mpi::TestMPITaskSequential::post_processing() {
  internal_order_test();
