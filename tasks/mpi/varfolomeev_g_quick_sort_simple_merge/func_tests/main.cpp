...
TEST(varfolomeev_g_quick_sort_simple_merge_mpi, Test_Sum) {
  ...
  if (world.rank() == 0) {
    ...
    global_vec = varfolomeev_g_quick_sort_simple_merge_mpi::getRandomVector(count_size_vector);
  ...
  if (world.rank() == 0) {
    ...
    // Create Task
    varfolomeev_g_quick_sort_simple_merge_mpi::TestMPITaskSequential testMpiTaskSequential(taskDataSeq);
...
// TEST(varfolomeev_g_quick_sort_simple_merge_mpi, Test_Diff) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
...
// TEST(varfolomeev_g_quick_sort_simple_merge_mpi, Test_Diff_2) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
//   std::vector<int32_t> global_diff(1, 0);
//   // Create TaskData
...
// TEST(varfolomeev_g_quick_sort_simple_merge_mpi, Test_Max) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
...
// TEST(varfolomeev_g_quick_sort_simple_merge_mpi, Test_Max_2) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
//   std::vector<int32_t> global_max(1, 0);
//   // Create TaskData
