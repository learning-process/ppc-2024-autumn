...
std::vector<int> getRandomVectora(int sz) {
...
TEST(matthew_fyodorov_reduce_mpi, TestMPITaskParallel_Sum_PositiveNumbers_2) {
  boost::mpi::environment env;
  boost::mpi::communicator world;
  int rank = world.rank();
  int size = world.size();
...
TEST(matthew_fyodorov_reduce_mpi, TestMPITaskParallel_Sum_PositiveNumbers_equiualents_zero) {
  boost::mpi::environment env;
  boost::mpi::communicator world;
  int rank = world.rank();
  int size = world.size();
...
TEST(matthew_fyodorov_reduce_mpi, TestMPITaskParallel_Sum_Positive_and_NegativeNumbers) {
  boost::mpi::environment env;
  boost::mpi::communicator world;
  int rank = world.rank();
  int size = world.size();
...
TEST(matthew_fyodorov_reduce_mpi, TestMPITaskParallel_Sum_Zero_Numbers) {
  boost::mpi::environment env;
  boost::mpi::communicator world;
  int rank = world.rank();
  int size = world.size();
