...
TEST(shuravina_o_jarvis_pass, Test_Single_Point) {
  int rank;
  MPI_Comm_rank(MPI_COMM_WORLD, &rank);

  std::vector<Point> global_points = {Point(1, 1)};
  std::vector<Point> global_hull;
...
TEST(shuravina_o_jarvis_pass, Test_Two_Points) {
  int rank;
  MPI_Comm_rank(MPI_COMM_WORLD, &rank);

  std::vector<Point> global_points = {Point(0, 0), Point(1, 1)};
  std::vector<Point> global_hull;
...
TEST(shuravina_o_jarvis_pass, Test_Negative_Coordinates) {
  int rank;
  MPI_Comm_rank(MPI_COMM_WORLD, &rank);

  std::vector<Point> global_points = {Point(-1, -1), Point(-2, -2), Point(0, 0), Point(1, 1), Point(2, 2)};
  std::vector<Point> global_hull;
...
TEST(shuravina_o_jarvis_pass, Test_Large_Coordinates) {
  int rank;
  MPI_Comm_rank(MPI_COMM_WORLD, &rank);

  std::vector<Point> global_points = {Point(1000000, 1000000), Point(2000000, 2000000), Point(0, 0)};
  std::vector<Point> global_hull;
