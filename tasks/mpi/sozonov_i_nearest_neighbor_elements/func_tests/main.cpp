...
TEST(sozonov_i_nearest_neighbor_elements_mpi, test_on_100_elements) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_ans(2, 0);
...
TEST(sozonov_i_nearest_neighbor_elements_mpi, test_on_200_elements) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_ans(2, 0);
  std::vector<int> ans(2, 1);
...
TEST(sozonov_i_nearest_neighbor_elements_mpi, test_random_on_100_elements) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_ans(2, 0);
  // Create TaskData
...
TEST(sozonov_i_nearest_neighbor_elements_mpi, test_random_on_200_elements) {
  boost::mpi::communicator world;
  std::vector<int> global_vec;
  std::vector<int32_t> global_ans(2, 0);
  // Create TaskData
