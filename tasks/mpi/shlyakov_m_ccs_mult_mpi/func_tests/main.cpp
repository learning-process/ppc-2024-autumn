...
TEST(shlyakov_m_ccs_mult_mpi, empty_matrices_test) {
...
TEST(shlyakov_m_ccs_mult_mpi, square_matrices_test1) {
  auto taskData = std::make_shared<ppc::core::TaskData>();
  boost::mpi::communicator world;
...
TEST(shlyakov_m_ccs_mult_mpi, square_matrices_test2) {
  auto taskData = std::make_shared<ppc::core::TaskData>();
  boost::mpi::communicator world;
...
TEST(shlyakov_m_ccs_mult_mpi, rectangular_matrices_test1) {
  auto taskData = std::make_shared<ppc::core::TaskData>();
  boost::mpi::communicator world;
...
TEST(shlyakov_m_ccs_mult_mpi, rectangular_matrices_test2) {
  auto taskData = std::make_shared<ppc::core::TaskData>();
  boost::mpi::communicator world;
...
TEST(shlyakov_m_ccs_mult_mpi, single_element_matrix_test) {
  auto taskData = std::make_shared<ppc::core::TaskData>();
  boost::mpi::communicator world;
...
TEST(shlyakov_m_ccs_mult_mpi, sparse_matrices_test) {
  auto taskData = std::make_shared<ppc::core::TaskData>();
  boost::mpi::communicator world;
...
TEST(shlyakov_m_ccs_mult_mpi, all_zeros_matrices_test) {
  auto taskData = std::make_shared<ppc::core::TaskData>();
  boost::mpi::communicator world;
