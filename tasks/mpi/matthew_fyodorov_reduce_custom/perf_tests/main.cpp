...
TEST(matthew_fyodorov_reduce_custom_mpi, test_pipeline_run) {
  ...
  auto testMpiTaskParallel = std::make_shared<matthew_fyodorov_reduce_custom_mpi ::TestMPITaskParallel>(taskDataPar);
...
TEST(matthew_fyodorov_reduce_custom_mpi, test_task_run) {
  boost::mpi::environment env;
  boost::mpi::communicator world;
