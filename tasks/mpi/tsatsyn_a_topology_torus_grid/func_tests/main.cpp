...
// TEST(tsatsyn_a_topology_torus_grid_mpi, Test_Send_30050) {
...
//   }
// }
// TEST(tsatsyn_a_topology_torus_grid_mpi, Test_Send_30000) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
//   std::vector<int32_t> global_sum(1, 0);
//   // Create TaskData
...
//   }
// }
// TEST(tsatsyn_a_topology_torus_grid_mpi, Test_Send_50000) {
//   boost::mpi::communicator world;
//   std::vector<int> global_vec;
//   std::vector<int32_t> global_sum(1, 0);
//   // Create TaskData
//   std::shared_ptr<ppc::core::TaskData> taskDataPar = std::make_shared<ppc::core::TaskData>();
//   const int count_size_vector = 50000;
//   if (world.rank() == 0) {
//     global_vec = tsatsyn_a_topology_torus_grid_mpi::getRandomVector(count_size_vector);
//     taskDataPar->inputs.emplace_back(reinterpret_cast<uint8_t*>(global_vec.data()));
//     taskDataPar->inputs_count.emplace_back(global_vec.size());
...
TEST(tsatsyn_a_topology_torus_grid_mpi, Test_Send_100000) {
  ...
  if (world.rank() == 0) {
    ASSERT_EQ(doublesize, global_sum[0]);
  }
}