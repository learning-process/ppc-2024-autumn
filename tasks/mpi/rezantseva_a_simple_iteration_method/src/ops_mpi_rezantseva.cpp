...
// int rezantseva_a_simple_iteration_method_mpi::vectorDotProduct(const std::vector<int>& v1, const std::vector<int>&
// v2) {
//   long long result = 0;
...
// }
//
// bool rezantseva_a_simple_iteration_method_mpi::TestMPITaskSequential::validation() {
//   internal_order_test();
...
// }
//
// bool rezantseva_a_simple_iteration_method_mpi::TestMPITaskSequential::pre_processing() {
//   internal_order_test();
...
// }
//
// bool rezantseva_a_simple_iteration_method_mpi::TestMPITaskSequential::run() {
//   internal_order_test();
...
// }
//
// bool rezantseva_a_simple_iteration_method_mpi::TestMPITaskSequential::post_processing() {
//   internal_order_test();
//   reinterpret_cast<int*>(taskData->outputs[0])[0] = res;
//   return true;
// }
//
// bool rezantseva_a_simple_iteration_method_mpi::TestMPITaskParallel::validation() {
//   internal_order_test();
//   if (world.rank() == 0) {
//     // Check count elements of output
//     return (taskData->inputs.size() == taskData->inputs_count.size() && taskData->inputs.size() == 2) &&
...
// }
//
// bool rezantseva_a_simple_iteration_method_mpi::TestMPITaskParallel::pre_processing() {
//   internal_order_test();
//
...
//       counts_[i] = delta + (i < remainder ? 1 : 0);  // Assign 1 additional element to the first 'remainder'
//       processes
//     }
//   }
...
// }
//
// bool rezantseva_a_simple_iteration_method_mpi::TestMPITaskParallel::run() {
//   internal_order_test();
//
//   if (world.rank() == 0) {
...
// }
//
// bool rezantseva_a_simple_iteration_method_mpi::TestMPITaskParallel::post_processing() {
//   internal_order_test();
//   if (world.rank() == 0) {
//     reinterpret_cast<int*>(taskData->outputs[0])[0] = res;
//   }
