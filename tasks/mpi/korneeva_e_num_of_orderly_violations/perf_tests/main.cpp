...
TEST(korneeva_e_num_of_orderly_violations_mpi, test_pipeline_execution) {
    ...
    // Create MPI task
    auto mpi_task = std::make_shared<korneeva_e_num_of_orderly_violations_mpi::num_of_orderly_violations<int, int>>(task_data);
...
TEST(korneeva_e_num_of_orderly_violations_mpi, test_task_run) {
    ...
    // Create MPI task
    auto testMpiTaskParallel = std::make_shared<korneeva_e_num_of_orderly_violations_mpi::num_of_orderly_violations<int, int>>(taskData);
