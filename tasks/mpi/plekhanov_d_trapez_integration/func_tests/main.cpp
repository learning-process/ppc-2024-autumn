...
TEST(plekhanov_d_trapez_integration_mpi, test_int_linear_func) {
  ...
  plekhanov_d_trapez_integration_mpi::TrapezoidalIntegralParallel testMpiTaskParallel(taskDataPar);
  ...
  if (world.rank() == 0) {
    ...
    plekhanov_d_trapez_integration_mpi::TrapezoidalIntegralSequential testMpiTaskSequential(taskDataSeq);
