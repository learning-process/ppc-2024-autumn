...
TEST(Parallel_Operations_MPI, Test_Matrix_Column_Max) {
  ...
  nasedkin_e_matrix_column_max_value_mpi::MatrixColumnMaxParallel testMpiTaskParallel(taskDataPar);
  ...
  if (world.rank() == 0) {
    ...
    // Create Task
    nasedkin_e_matrix_column_max_value_mpi::MatrixColumnMaxSequential testMpiTaskSequential(taskDataSeq);
