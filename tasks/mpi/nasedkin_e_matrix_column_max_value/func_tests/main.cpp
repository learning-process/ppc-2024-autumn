...
TEST(MatrixColumnMaxTest, SequentialMaxTest) {
    ...
    auto seqTask = std::make_shared<nasedkin_e_matrix_column_max_value_mpi::MatrixColumnMaxTaskSequential>(taskDataSeq, "max");
...
TEST(MatrixColumnMaxTest, ParallelMaxTest) {
    ...
    auto parTask = std::make_shared<nasedkin_e_matrix_column_max_value_mpi::MatrixColumnMaxTaskParallel>(taskDataPar, "max");
