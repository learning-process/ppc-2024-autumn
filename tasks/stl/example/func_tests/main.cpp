...
TEST(Parallel_Operations_STL_Threads, Test_Sum) {
  ...
  std::vector<int> vec = chistov_a_test_task_stl::getRandomVector(static_cast<int>(nthreads));
  // Create data
  ...
  // Create Task
  chistov_a_test_task_stl::TestSTLTaskSequential TestSTLTaskSequential(taskDataSeq, "+");
  ...
  // Create Task
  chistov_a_test_task_stl::TestSTLTaskParallel TestSTLTaskParallel(taskDataPar, "+");
